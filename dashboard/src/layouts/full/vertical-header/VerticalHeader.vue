...
<template>
  <v-app-bar elevation="0" height="70">
    ...
    <span style="margin-left: 16px; font-size: 24px; font-weight: 1000;">Aptix<span
    ...
    <v-dialog v-model="updateStatusDialog" width="700">
      ...
      <v-card>
        <v-card-title>
          <span class="text-h5">更新 AptixBot</span>
        </v-card-title>
        <v-card-text>
          <v-container>
            ...
            <div style="margin-top: 16px;">
              ...
              <div class="mb-4">
                <small>跳到旧版本不会重新下载管理面板文件，这可能会造成部分数据显示错误。您可在 <a href="https://github.com/Aptix/AptixBot/releases">此处</a>
              ...
              <div class="mb-4">
                ...
                <br>
                <a href="https://github.com/Aptix/AptixBot/commits/master"><small>查看 master 分支提交记录（点击右边的 copy
                    即可复制）</small></a>
              </div>
    ...
    <v-dialog v-model="dialog" persistent width="700">
      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <small>默认用户名和密码是 Aptixbot。</small>
          <br>
          <small>{{ status }}</small>
        </v-card-text>
        <v-card-actions>
