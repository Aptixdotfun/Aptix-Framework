...
from Aptixbot.core.provider.provider import Provider
from Aptixbot.core.db import BaseDatabase
from Aptixbot.core.config.Aptixbot_config import AptixBotConfig
from Aptixbot.core.provider.func_tool_manager import FuncCall
...
class Context:
    ...
    def get_config(self) -> AptixBotConfig:
        '''获取 AptixBot 的配置。'''
        return self._config
    ...
    '''
    以下的方法已经不推荐使用。请从 AptixBot 文档查看更好的注册方式。
    '''
    ...
    def register_llm_tool(self, name: str, func_args: list, desc: str, func_obj: Awaitable) -> None:
        ...
        异步处理函数会接收到额外的的关键词参数：event: AptixMessageEvent, context: Context。
        '''
