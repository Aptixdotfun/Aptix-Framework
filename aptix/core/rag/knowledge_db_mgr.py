...
class KnowledgeDBManager():
    def __init__(self, Aptixbot_config: AptixBotConfig) -> None:
        self.db_path = "data/knowledge_db/"
        self.config = Aptixbot_config.get("knowledge_db", {})
    ...
    async def create_knowledge_db(self, name: str, config: Dict):
        ...
        self.Aptixbot_config["knowledge_db"] = self.config
        self.Aptixbot_config.save_config()
