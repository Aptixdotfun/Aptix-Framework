...
from Aptixbot.api.message_components import Image, Plain, At
from Aptixbot.core.platform.Aptix_message_event import MessageSesion
from .qqofficial_message_event import QQOfficialMessageEvent
from ...register import register_platform_adapter
from Aptixbot.core.message.components import BaseMessageComponent
...
class botClient(Client):
    ...
    def _commit(self, abm: AptixBotMessage):
