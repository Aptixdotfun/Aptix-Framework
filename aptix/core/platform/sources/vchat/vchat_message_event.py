...
class VChatPlatformEvent(AptixMessageEvent):
    def __init__(self, message_str: str, message_obj: AptixBotMessage, platform_meta: PlatformMetadata, session_id: str, client: Core):
