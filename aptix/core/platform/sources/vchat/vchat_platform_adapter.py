...
from Aptixbot.api.message_components import *
...
class VChatPlatformAdapter(Platform):
    ...
    def convert_message(self, msg: model.Message) -> AptixBotMessage:
        # credits: https://github.com/z2z63/Aptixbot_plugin_vchat/blob/master/main.py#L49
        assert isinstance(msg.content, model.TextContent)
        amsg = AptixBotMessage()
