...
from Aptixbot.core.utils.dify_api_client import DifyAPIClient
from Aptixbot.core.utils.io import download_image_by_url
from Aptixbot.core import logger, sp
...
class ProviderDify(Provider):
    def __init__(
        ...
        self.workflow_output_key = provider_config.get("dify_workflow_output_key", "Aptixbot_wf_output")
        ...
        match self.api_type:
            ...
            case "workflow":
                async for chunk in self.api_client.workflow_run(
                    inputs={
                        "Aptixbot_text_query": prompt,
                        "Aptixbot_session_id": session_id,
                        **session_var
                    },
                    user=session_id,
                    files=files_payload
