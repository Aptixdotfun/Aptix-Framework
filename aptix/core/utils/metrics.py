...
from Aptixbot.core import db_helper, logger

logger = logging.getLogger("Aptixbot")

class Metric():
    @staticmethod
    async def upload(**kwargs):
        '''
        上传相关非敏感的指标以更好地了解 AptixBot 的使用情况。上传的指标不会包含任何有关消息文本、用户信息等敏感信息。
        
        Powered by TickStats.
        '''
        base_url = "https://tickstats.Aptix.top/api/metric/90a6c2a1"
        kwargs["v"] = VERSION
