...
from Aptixbot.core.config import VERSION
from Aptixbot.core.utils.io import download_image_by_url

AptixBOT_T2I_DEFAULT_ENDPOINT = "https://t2i.Aptix.top/text2img"

class NetworkRenderStrategy(RenderStrategy):
    def __init__(self, base_url: str = AptixBOT_T2I_DEFAULT_ENDPOINT) -> None:
        super().__init__()
        if not base_url:
            base_url = AptixBOT_T2I_DEFAULT_ENDPOINT
