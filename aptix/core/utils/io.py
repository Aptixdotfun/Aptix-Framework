...
async def download_dashboard():
    '''下载管理面板文件'''
    dashboard_release_url = "https://Aptixbot-registry.Aptix.top/download/Aptixbot-dashboard/latest/dist.zip"
    try:
        await download_file(dashboard_release_url, "data/dashboard.zip", show_progress=True)
    except BaseException as _:
        dashboard_release_url = "https://github.com/Aptix/AptixBot/releases/latest/download/dist.zip"
        await download_file(dashboard_release_url, "data/dashboard.zip", show_progress=True)
    print("解压管理面板文件中...")
