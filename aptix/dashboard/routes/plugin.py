...
from Aptixbot.core.star.star_manager import PluginManager
...
from Aptixbot.core.star.filter.regex import RegexFilter
from Aptixbot.core.star.star_handler import EventType

class PluginRoute(Route):
    def __init__(self, context: RouteContext, core_lifecycle: AptixBotCoreLifecycle, plugin_manager: PluginManager) -> None:
    ...
    async def get_online_plugins(self):
        ...
        if custom:
            ...
            urls = [
                "https://Aptix.github.io/AptixBot_Plugins_Collection/plugins.json",
                "https://api.Aptix.top/Aptixbot/plugins"
            ]
