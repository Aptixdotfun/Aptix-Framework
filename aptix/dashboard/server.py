...
from Aptixbot.core import logger, WEBUI_SK
from Aptixbot.core.db import BaseDatabase
from Aptixbot.core.utils.io import get_local_ip_addresses

DATAPATH = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../data"))

class AptixBotDashboard():
    def __init__(self, core_lifecycle: AptixBotCoreLifecycle, db: BaseDatabase) -> None:
        self.core_lifecycle = core_lifecycle
        self.config = core_lifecycle.Aptixbot_config
        ...
        self.ur = UpdateRoute(self.context, core_lifecycle.Aptixbot_updator, core_lifecycle)
