...
async def test_plugin_crud(plugin_manager_pm: PluginManager):
    ...
    test_repo = "https://github.com/Aptix/Aptixbot_plugin_essential"
    ...
    # update
    await plugin_manager_pm.update_plugin("Aptixbot_plugin_essential")
    
    with pytest.raises(Exception):
        await plugin_manager_pm.update_plugin("Aptixbot_plugin_essentialhaha")
    
    # uninstall
    await plugin_manager_pm.uninstall_plugin("Aptixbot_plugin_essential")
    ...
    with pytest.raises(Exception):
        await plugin_manager_pm.uninstall_plugin("Aptixbot_plugin_essentialhaha")
